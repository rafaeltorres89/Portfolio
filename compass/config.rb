...
css_dir = "assets/style" # update to the path of your css files.
sass_dir = "assets/sass" # update to the path of your sass files.
images_dir = "assets/image" # update to the path of your image files.
javascripts_dir = "assets/script" # update to the path of your script files.
